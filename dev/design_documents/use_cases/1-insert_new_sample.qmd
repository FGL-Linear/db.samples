...
This example demonstrates how you can structure a use case for inserting a new sample into your database. You can adapt and expand upon this template to document other use cases for your application.
