...
WITH RECURSIVE LotChain AS (
    ...
    FROM lot_changes
    WHERE new_id_supplier = ?  -- Specify the ID of the given lot
      AND new_reference = ?     -- Specify the reference of the given lot
      AND new_lot = ?           -- Specify the lot number of the given lot
  UNION ALL
